import { fetchRaportiShoferit, fetchRaportiShoferitPadeklauar } from "@/utils/queries";
...
export async function RaportiShoferitPadeklauarTable() {
   const data: RaportiShoferit[] = await fetchRaportiShoferitPadeklauar();
   // console.log(data)
   return (
